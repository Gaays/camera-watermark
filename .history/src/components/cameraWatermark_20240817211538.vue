  ...
  if (file) {
    ...
    reader.onload = function (e) {
      ...
      img.onload = function () {
        ...
        const log = [
          {
            name: 'imgHeigh', value: img.height, newValue: imgHeight,
          },
          {
            name: 'imgWidth', value: img.width, newValue: imgWidth,
          },
          {
            name: 'canvasHeight', value: imgBox.value.height,
          },
          {
            name: 'canvasWidth', value: imgBox.value.width,
          },
        ]
        console.table(log);
